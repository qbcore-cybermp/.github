# Contributing to QBCore CyberMP

Thank you for helping improve QBCore CyberMP. These guidelines apply across the
organization unless a repository documents a more specific requirement.

## Choose the right channel

- Use a bug form for a reproducible defect in an official QBCore CyberMP project.
...
- Use the [QBCore CyberMP projects](https://github.com/qbcore-cybermp) and
  [official Discord](https://discord.gg/qbcore) for installation,
  configuration, and usage support.
- Follow the [QBCore CyberMP Code of Conduct](CODE_OF_CONDUCT.md) whenever you
...
There is no single test command shared across QBCore CyberMP repositories. At
minimum:

- Run every check or lint workflow provided by the repository.
- Test with the stated CyberMP and Cyberpunk 2077 versions and compatible
  official dependencies.
- Record the exact project or module commit, CyberMP version, and game version.
- Verify relevant CyberMP client and server logs for new warnings or errors.
- Test client and server startup, reconnect and restart behavior, and the
  smallest reliable reproduction for the changed behavior.
...
manual CyberMP client and server testing.
